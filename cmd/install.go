...
func init() {
	...
	installCmd.Flags().BoolP("dev", "d", false, "Clone full git repository (for development)")
    installCmd.Flags().BoolP("stable", "s", false, "Update latest stable release")
    installCmd.Flags().BoolP("indev", "i", false, "Update latest pre-release")
